 ...
 */
public class VerticalBarLayoutManagerAdapter extends RecyclerView.Adapter<VerticalBarLayoutManagerAdapter.ViewHolder> {
    private final Context    context;
    private final List<User> list;

    public VerticalBarLayoutManagerAdapter(Context context) {
